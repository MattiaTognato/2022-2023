            ...
            <h5 class="mb-2 text-2xl font-bold break-normal  text-teal-700">' . $film['nome'] . '</h5>
              <div class="flex justify-around">
                <form action="/index.php/booking" method="get">
                  ...
                  <button type="submit" class="'.$disable.' mt-2 text-white w-32 bg-teal-500 hover:bg-teal-600 focus:ring-4 focus:outline-none focus:ring-teal-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-teal-400 dark:hover:bg-teal-500 dark:focus:ring-teal-600">
